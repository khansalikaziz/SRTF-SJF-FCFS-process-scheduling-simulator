...
function showOutput(flag) {
    ...
    gt.innerHTML = "";
    gt.setAttribute("style", "width: auto; height: 100px; position: relative; margin: auto; border: .5px solid black;");
    var table = document.getElementById("ptable");
    table.innerHTML = "";
    var timer1 = document.getElementById("timer");
    timer1.setAttribute("style", "width: auto; height: 100px; position: relative; margin: auto; border: .5px solid black;");
    timer1.innerHTML = "";
